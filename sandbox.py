...
# Coord des gares ici a la main mais voila
stations = {
...
# Départ / Arrivé entry boxes
start_label = tkinter.Label(root_tk, text="Départ:")
...
goal_label = tkinter.Label(root_tk, text="Arrivée:")
...
calculate_button = tkinter.Button(root_tk, text="Calculer", command=on_calculate_path)
calculate_button.place(x=700, y=10)
